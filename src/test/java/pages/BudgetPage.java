...
public class BudgetPage{
   ...
   @FindBy(xpath = "(//button[@class='vehicle-type-tile'])[1]")
    ...
    @FindBy (xpath = "//span[@class='refinement-pill--text kmx-typography--body-1']")
    public WebElement filterType;
    
    @FindBy (xpath = "(//span[@class='refinement-pill--text kmx-typography--body-1'])[2]")
    public WebElement filterAmount;
